...
/**
 * Constants for the project. Have the constants only if they are used in multiple classes otherwise
 * keep them in their own class.
 */
public final class Constants {
  ...
  public static final String[] FILTER_CATEGORIES =
      new String[] {
        CISCOPLUS_FILTER,
        SUCCESS_TRACKS_FILTER,
        LIFECYCLE_FILTER,
        TECHNOLOGY_FILTER, // DOCUMENTATION_FILTER,
        ROLE_FILTER,
        LIVE_EVENTS_FILTER,
        FOR_YOU_FILTER,
        CONTENT_TYPE_FILTER,
  ...
  public static final String[] FILTER_CATEGORIES_ROLE =
      new String[] {
  ...
  public static final String[] FILTER_CATEGORIES_TOPPICKS =
      new String[] {
        ROLE_FILTER, // CISCOPLUS_FILTER,
        SUCCESS_TRACKS_FILTER,
        LIFECYCLE_FILTER,
        TECHNOLOGY_FILTER,
        LIVE_EVENTS_FILTER,
  ...
  public static final String[] FOR_YOU_KEYS =
      new String[] {
        "New", "Top Picks", "Based on Your Customers", "Bookmarked", "Popular with Partners"
      };
