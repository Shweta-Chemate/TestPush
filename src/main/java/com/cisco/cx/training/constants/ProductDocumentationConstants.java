...
public class ProductDocumentationConstants {
  ...
  public static final String FIELDS_CL =
      " cl.learning_item_id, cl.learning_type, cl.title , cl.description, cl.status, "
  ...
  public static final String CASE_CLAUSE_WHERE_CL =
      " where " + CASE_CLAUSE_CL + "and" + HCAAS_CLAUSE_CL;
  public static final String CASE_CLAUSE_AND_CL =
      " and " + CASE_CLAUSE_CL + "and" + HCAAS_CLAUSE_CL;

  public static final String DYNAMIC_FROM_SUBQUERY =
      " from ( select "
          + FIELDS_CL // cl.* "
  ...
  /** all cards * */
  public static final String GET_LM_LEARNING_CARDS =
      " union ( select learning_map_id as learning_item_id,  "
  ...
  public static final String ALL_CARDS =
      "select cl.*, CT.asset_types,CT.asset_links, CT.asset_description, CT.asset_titles, mp.title as learning_map  "
  ...
  public static final String GET_PD_LEARNING_CARDS =
      "select * from ( " + ALL_CARDS + " ) as cl " + "  \n-- #sort\n";

  /** search * */
  public static final String GET_PD_LEARNING_CARDS_SEARCH =
      "select * from ( "
          + ALL_CARDS
          + " ) as cl "
  ...
  public static final String GET_PD_LEARNING_CARD_IDS_SEARCH =
      " select cl.learning_item_id "
          + " from ( "
          + ALL_CARDS
          + " ) as cl "
          + " where lower(cl.title) like :likeToken or lower(cl.description) like :likeToken  "
  ...
  /** Filter * */
  public static final String GET_PD_LEARNING_BY_CONTENT_TYPE =
      "select distinct learning_item_id "
          + " from cxpp_db.cxpp_item_link "
          + " where asset_type in (:contentTypeFilter) "
          + CASE_CLAUSE_AND;

  public static final String GET_PD_LEARNING_CARDS_BY_FILTER =
      "select * from ( "
          + ALL_CARDS
          + " ) as cl "
  ...
  /** filter + search */
  public static final String GET_PD_LEARNING_CARDS_FILTERED_SEARCH =
      "select * from ( "
          + ALL_CARDS
          + " ) as cl "
  ...
  public static final String GET_PD_LEARNING_CARD_IDS_FILTERED_SEARCH =
      " select cl.learning_item_id "
          + " from ( "
          + ALL_CARDS
          + " ) as cl "
  ...
  /** other filters * */
  public static final String GET_PD_CARD_IDS_REGION =
      " select learning_item_id "
          + " from cxpp_db.cxpp_learning_item  "
          + " where  piw_region in (:values)"
          + CASE_CLAUSE_AND;

  public static final String GET_PD_CARD_IDS_LG =
      " select learning_item_id "
          + " from cxpp_db.cxpp_learning_item  "
          + " where  piw_language in (:values)"
          + CASE_CLAUSE_AND;

  public static final String GET_PD_CARD_IDS_AT =
      " select learning_item_id from ( "
  ...
  public static final String GET_PD_CARD_IDS_TC =
      " select learning_item_id from ( "
  ...
  public static final String GET_LM_STUCPT_WITH_COUNT =
      " union (select distinct lmt.learning_map_id as learning_item_id , "
  ...
  public static final String GET_LM_STUCPT_WITH_COUNT_BY_CARDS =
      " union (select distinct lmt.learning_map_id as learning_item_id , "
          + " pitstop, usecase, successtrack "
          + " from cxpp_db.cxpp_learning_successtrack st "
          + "	inner join cxpp_db.cxpp_learning_usecase uc  "
  ...
  public static final String GET_PD_CARD_IDS_BY_STUCPS =
      " select learning_item_id from ( "
  ...
  // + " where ps.pitstop in (:pitstopInp) and uc.usecase = :usecaseInp and st.successtrack =
  // :successtrackInp"

  /** LM counts * */
  public static final String GET_LM_TECHNOLOGY_WITH_COUNT =
      " union (select distinct tc.technology, lmt.learning_map_id as learning_item_id "
  ...
  public static final String GET_LM_TECHNOLOGY_WITH_COUNT_BY_CARDS =
      " union (select distinct tc.technology, lmt.learning_map_id as learning_item_id "
          + " from cxpp_db.cxpp_learning_technology tc left join "
          + " ( "
          + " select lm.learning_map_id, lm.title as learning_map, it.learning_item_id  "
  ...
  public static final String GET_LM_DOCUMENTATION_WITH_COUNT =
      " union (select  it.archetype, lm.learning_map_id as learning_item_id "
  ...
  public static final String GET_LM_DOCUMENTATION_WITH_COUNT_BY_CARDS =
      " union (select  it.archetype, lm.learning_map_id as learning_item_id "
          + "		from cxpp_db.cxpp_learning_item it "
          + "		left join "
          + "		cxpp_db.cxpp_learning_map lm "
  ...
  /** count by cards * */
  public static final String GET_PD_TECHNOLOGY_WITH_COUNT_BY_CARD =
      " select technology as dbkey, count(*) as dbvalue "
          + " from ( select technology, learning_item_id "
          + " from cxpp_db.cxpp_learning_technology "
          + " where learning_item_id in (:cardIds) "
          + CASE_CLAUSE_AND
          + GET_LM_TECHNOLOGY_WITH_COUNT_BY_CARDS
          + " ) as T "
          + " group by technology "
          + " order by technology;";

  public static final String GET_PD_CONTENT_TYPE_WITH_COUNT_BY_CARD =
      "select asset_type as dbkey, count(*) as dbvalue from "
  ...
  public static final String GET_PD_LANGUAGE_WITH_COUNT_BY_CARD =
      "select piw_language as dbkey, count(*) as dbvalue "
          + " from cxpp_db.cxpp_learning_item "
          + " where learning_item_id in (:cardIds) "
          + CASE_CLAUSE_AND
  ...
  public static final String GET_PD_DOCUMENTATION_WITH_COUNT_BY_CARD =
      "select archetype as dbkey, count(*) as dbvalue "
  ...
  public static final String GET_PD_LIVE_EVENTS_WITH_COUNT_BY_CARD =
      "select piw_region as dbkey, count(*) as dbvalue "
          + " from cxpp_db.cxpp_learning_item "
          + " where learning_item_id in (:cardIds) "
          + CASE_CLAUSE_AND
          + " group by piw_region "
  ...
  /** all counts * */
  public static final String GET_PD_CONTENT_TYPE_WITH_COUNT =
      "select asset_type as dbkey, count(*) as dbvalue from "
          + " (select learning_item_id , asset_type "
          + " from cxpp_db.cxpp_item_link "
          + CASE_CLAUSE_WHERE
  ...
  public static final String GET_PD_TECHNOLOGY_WITH_COUNT =
      "select technology as dbkey, count(*) as dbvalue "
          + " from ( select technology, learning_item_id "
          + " from cxpp_db.cxpp_learning_technology "
          + CASE_CLAUSE_WHERE
          + GET_LM_TECHNOLOGY_WITH_COUNT
          + " ) as T "
          + " group by technology order by technology;";

  public static final String GET_PD_LANGUAGE_WITH_COUNT =
      "select piw_language as dbkey, count(*) as dbvalue "
          + " from cxpp_db.cxpp_learning_item "
          + CASE_CLAUSE_WHERE
          + " group by piw_language "
  ...
  public static final String GET_PD_DOCUMENTATION_WITH_COUNT =
      "select archetype as dbkey, count(*) as dbvalue "
          + " from ( select archetype, learning_item_id "
          + " from cxpp_db.cxpp_learning_item "
          + CASE_CLAUSE_WHERE
  ...
  public static final String GET_PD_LIVE_EVENTS_WITH_COUNT =
      "select piw_region as dbkey, count(*) as dbvalue "
          + " from cxpp_db.cxpp_learning_item "
          + CASE_CLAUSE_WHERE
          + " group by piw_region "
  ...
  /** ST * */
  public static final String GET_PD_ST_UC_PS_WITH_COUNT =
      "select count(*) as dbvalue ,  pitstop, usecase, successtrack "
  ...
  public static final String GET_PD_ST_UC_PS_WITH_COUNT_BY_CARDS =
      "select count(*) as dbvalue ,  pitstop, usecase, successtrack "
          + " from ( select learning_item_id, pitstop, usecase, successtrack "
          + "	from cxpp_db.cxpp_learning_successtrack st  "
          + "	inner join cxpp_db.cxpp_learning_usecase uc  "
          ...
          + " where learning_item_id in (:cardIds) "
          + CASE_CLAUSE_AND // AND !
          + GET_LM_STUCPT_WITH_COUNT_BY_CARDS
          + " ) as T "
          + " group by pitstop,usecase,successtrack "
          + " order by successtrack,usecase,pitstop ";

  /** skill - for role no case clause required * */
  public static final String GET_LM_ROLE_WITH_COUNT =
      "union (  "
  ...
  public static final String GET_LM_CISCOPLUS_WITH_COUNT =
      "union (  "
  ...
  public static final String GET_LM_ROLE_WITH_COUNT_BY_CARDS =
      "union (  "
          + "select distinct tc.roles, lmt.learning_map_id as learning_item_id "
          + "from cxpp_db.cxpp_learning_roles tc left join "
          + "( "
  ...
  public static final String GET_LM_CISCOPLUS_WITH_COUNT_BY_CARDS =
      "union (  "
          + "select distinct tc.ciscoplus, lmt.learning_map_id as learning_item_id "
          + "from cxpp_db.cxpp_learning_ciscoplus tc left join "
          + "( "
  ...
  public static final String GET_PD_ROLE_WITH_COUNT =
      "select roles as dbkey, count(*) as dbvalue "
          + " from ( select roles, learning_item_id "
          + "	from cxpp_db.cxpp_learning_roles 		"
          + CASE_CLAUSE_WHERE
          + GET_LM_ROLE_WITH_COUNT
          + " ) as T "
          + " group by roles order by roles ";

  public static final String GET_PD_CISCOPLUS_WITH_COUNT =
      "select ciscoplus as dbkey, count(*) as dbvalue "
          + " from ( select ciscoplus, learning_item_id "
          + "	from cxpp_db.cxpp_learning_ciscoplus "
          + CASE_CLAUSE_WHERE
          + GET_LM_CISCOPLUS_WITH_COUNT
          + " ) as T "
          + " group by ciscoplus order by ciscoplus ";

  public static final String GET_PD_CARD_IDS_ROLE =
      " select learning_item_id from ( "
  ...
  public static final String GET_PD_CARD_IDS_CISCOPLUS =
      " select learning_item_id from ( "
  ...
  public static final String GET_PD_ROLE_WITH_COUNT_BY_CARD =
      " select roles as dbkey, count(*) as dbvalue "
          + " from ( select roles, learning_item_id "
          + " from cxpp_db.cxpp_learning_roles "
          + " where learning_item_id in (:cardIds) "
          + CASE_CLAUSE_AND
          + GET_LM_ROLE_WITH_COUNT_BY_CARDS
          + " ) as T "
          + " group by roles "
          + " order by roles;";

  public static final String GET_PD_CISCOPLUS_WITH_COUNT_BY_CARD =
      " select ciscoplus as dbkey, count(*) as dbvalue "
          + " from ( select ciscoplus, learning_item_id "
          + " from cxpp_db.cxpp_learning_ciscoplus "
          + " where learning_item_id in (:cardIds) "
          + CASE_CLAUSE_AND
          + GET_LM_CISCOPLUS_WITH_COUNT_BY_CARDS
          + " ) as T "
          + " group by ciscoplus "
          + " order by ciscoplus;";

  /** For You - New * */
  public static final String GET_PD_YOU_CARD_IDS_BY_CARD =
      "select learning_item_id "
          + " from cxpp_db.cxpp_learning_item "
          + " where learning_item_id in (:cardIds) "
          + CASE_CLAUSE_AND;
  ...
  /** learning map * */
  public static final String GET_PD_LEARNING_MAP_COUNTS =
      "select mp.learning_map_id as dbkey, count(*) as dbvalue"
          + " from cxpp_db.cxpp_learning_item cl "
  ...
  /** lifecycle * */
  public static final String GET_LM_STUC_WITH_COUNT =
      " union (select distinct lmt.learning_map_id as learning_item_id , "
  ...
  public static final String GET_LM_STUC_WITH_COUNT_BY_CARDS =
      " union (select distinct lmt.learning_map_id as learning_item_id , "
          + " usecase, successtrack "
          + " from cxpp_db.cxpp_learning_successtrack st "
          + "	inner join cxpp_db.cxpp_learning_usecase uc  "
  ...
  public static final String GET_PD_ST_UC_WITH_COUNT =
      "select count(*) as dbvalue ,  usecase, successtrack "
  ...
  public static final String GET_LM_PT_WITH_COUNT =
      " union (select distinct lmt.learning_map_id as learning_item_id , "
          + " pitstop "
          + " from cxpp_db.cxpp_learning_successtrack st "
          + "	inner join cxpp_db.cxpp_learning_usecase uc  "
  ...
  public static final String GET_LM_PT_WITH_COUNT_BY_CARDS =
      " union (select distinct lmt.learning_map_id as learning_item_id , "
          + " pitstop "
          + " from cxpp_db.cxpp_learning_successtrack st "
          + "	inner join cxpp_db.cxpp_learning_usecase uc  "
  ...
  public static final String GET_PD_PS_WITH_COUNT =
      "select count(*) as dbvalue ,  pitstop as dbkey "
          ...
          + "	on ps.usecase_id = uc.usecase_id  "
          + CASE_CLAUSE_WHERE // WHERE !
          + GET_LM_PT_WITH_COUNT
          + " ) as T "
          + " group by pitstop "
          + " order by pitstop ";

  public static final String GET_PD_CARD_IDS_BY_PITSTOP =
      " select learning_item_id from ( "
          + " ( select learning_item_id , pitstop, usecase, successtrack "
          + " from cxpp_db.cxpp_learning_successtrack st "
          + " inner join cxpp_db.cxpp_learning_usecase uc "
  ...
  public static final String GET_PD_ST_UC_WITH_COUNT_BY_CARDS =
      "select count(*) as dbvalue , usecase, successtrack "
          + " from ( select learning_item_id, usecase, successtrack "
          + "	from cxpp_db.cxpp_learning_successtrack st  "
          + "	inner join cxpp_db.cxpp_learning_usecase uc  "
          ...
          + " where learning_item_id in (:cardIds) "
          + CASE_CLAUSE_AND // AND !
          + GET_LM_STUC_WITH_COUNT_BY_CARDS
          + " ) as T "
          + " group by usecase,successtrack "
          + " order by successtrack,usecase ";

  public static final String GET_PD_PS_WITH_COUNT_BY_CARDS =
      "select count(*) as dbvalue ,  pitstop as dbkey "
          + " from ( select learning_item_id, pitstop "
          + "	from cxpp_db.cxpp_learning_successtrack st  "
          + "	inner join cxpp_db.cxpp_learning_usecase uc  "
          ...
          + " where learning_item_id in (:cardIds) "
          + CASE_CLAUSE_AND // AND !
          + GET_LM_PT_WITH_COUNT_BY_CARDS
          + " ) as T "
          + " group by pitstop "
          + " order by pitstop ";

  /** for preferences * */
  public static final String GET_UPCOMING_WEBINARS =
      " select * from ( "
          + ALL_CARDS
          + " ) as UW "
          + " where UW.asset_types like '%Live Webinar%' and  UW.sort_by_date > current_date() and UW.status!='cancelled' ";

  public static final String GET_SPECIALIZED_CARDS =
      "select learning_item_id from cxpp_db.cxpp_learning_item where specialization in (:specializations) ";
  ...
  public static final String GET_TP_LEARNING_BY_CONTENT_TYPE =
      GET_PD_LEARNING_BY_CONTENT_TYPE + TP_IN_CLAUSE;
