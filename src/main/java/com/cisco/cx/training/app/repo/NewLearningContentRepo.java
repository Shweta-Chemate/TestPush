...
public interface NewLearningContentRepo
    extends JpaRepository<NewLearningContentEntity, String>,
        JpaSpecificationExecutor<NewLearningContentEntity> {
  ...
  List<NewLearningContentEntity> getRecentlyViewedContentFiltered(
      String userId, Set<String> learningItemIds, String hcaasStatus);

  @Query(value = SQLConstants.GET_RECENTLY_VIEWED_IDs, nativeQuery = true)
  Set<String> getRecentlyViewedContentFilteredIds(
      String userId, Set<String> learningItemIds, String hcaasStatus);
  ...
  List<NewLearningContentEntity> findUpcomingFiltered(
      Set<String> learningItemIds, String hcaasStatus);
  ...
  Set<String> getCardIdsByUcStFilter(
      String successtrackInp, Set<String> usecaseInp, Set<String> learningItemIds);
  ...
  List<NewLearningContentEntity> findByLearningTypeAndLearningMap(
      String learning_type, String learning_map);
  ...
  List<NewLearningContentEntity> getPopularAcrossPartners(
      Integer limitNormal,
      Integer limitExtended,
      Integer mx,
      Set<String> userBookmarks,
      String hcaasStatus);

  @Query(value = SQLConstants.GET_POPULAR_ACCROSS_PARTNERS_FILTERED, nativeQuery = true)
  List<NewLearningContentEntity> getPopularAcrossPartnersFiltered(
      Set<String> learningItemIds,
      Integer limitNormal,
      Integer limitExtended,
      Integer mx,
      Set<String> userBookmarks,
  ...
  List<NewLearningContentEntity> getPopularAtPartner(
      String puid,
      Integer limit,
      Integer limitExtended,
      Set<String> userBookmarks,
  ...
  List<NewLearningContentEntity> getPopularAtPartnerFiltered(
      String puid,
      Set<String> learningItemIds,
      Integer limit,
      Integer limitExtended,
  ...
  List<NewLearningContentEntity> findFeaturedFiltered(
      Set<String> learningItemIds, String hcaasStatus);
