...
public class PropertyConfiguration {
  ...
  public static final InstanceProfileCredentialsProvider credentialProvider =
  ...
  public String getCxpBasicAuthUserName() {
    if (StringUtils.isBlank(cryptoAccess.unseal(cxpBasicAuthUserName))) {
      throw new IllegalStateException(
          "CXP Basic Auth Username not present in ENV. Please set cxp_basicauth_username");
    }
  ...
  public String getCxpBasicAuthPassword() {
    if (StringUtils.isBlank(cryptoAccess.unseal(cxpBasicAuthPassword))) {
      throw new IllegalStateException(
          "CXP Basic Auth Password not present in ENV. Please set cxp_basicauth_password");
    }
  ...
  public void setSuccessTalkRegistrationSheetId(long successTalkRegistrationSheetId) {
    this.successTalkRegistrationSheetId =
        cryptoAccess.seal(String.valueOf(successTalkRegistrationSheetId));
  }
  ...
  public String createCxpBasicAuthToken() {
    return new String(
        Base64.encodeBase64(
            (this.getCxpBasicAuthUserName() + ":" + this.getCxpBasicAuthPassword()).getBytes()));
  }
