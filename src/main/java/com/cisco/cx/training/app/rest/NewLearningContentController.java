...
public class NewLearningContentController {
  ...
  @Autowired private LearningContentService learningContentService;

  @GetMapping(produces = MediaType.APPLICATION_JSON_VALUE, path = "/successTalks")
  @ApiOperation(
      value = "Fetch SuccessTalks For User",
      response = SuccessTalkResponseSchema.class,
      nickname = "fetchUserSuccessTalks")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<SuccessTalkResponseSchema> getUserSuccessTalks(
    ...
    SuccessTalkResponseSchema successTalkResponseSchema =
        learningContentService.fetchSuccesstalks(ccoId, sortField, sortType, filter, search);
  ...
  public List<PIW> getAllPIWs(
    ...
    String ccoId = MasheryObject.getInstance(xMasheryHandshake).getCcoId();
    List<PIW> piwItems =
        learningContentService.fetchPIWs(ccoId, region, sortField, sortType, filter, search);
  ...
  @ApiOperation(
      value = "Fetch all index counts",
      response = SuccessTalkResponseSchema.class,
      nickname = "fetchIndexCounts")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<CountResponseSchema> getIndexCounts(
      @ApiParam(value = "Mashery user credential header")
          @RequestHeader(value = "X-Mashery-Handshake", required = false)
          String xMasheryHandshake,
  ...
  public ResponseEntity<List<LearningContentItem>> getNewLearningContent(
      @ApiParam(value = "Mashery user credential header")
          ...
          String xMasheryHandshake,
      @ApiParam(value = "puid") @RequestHeader(value = "puid", required = true) String puid,
      @ApiParam(value = "Filters") @RequestBody(required = false)
    ...
    boolean hcaasStatus = getHcaasStatus(request);
    String ccoId = MasheryObject.getInstance(xMasheryHandshake).getCcoId();
    List<LearningContentItem> newLearningContentList =
        learningContentService.fetchNewLearningContent(ccoId, filtersSelected, hcaasStatus);
    LOG.info(
        "Received new learning content in {} ", (System.currentTimeMillis() - requestStartTime));
  ...
  public ResponseEntity<Map<String, Object>> getNewLearningsFilters(
      @ApiParam(value = "JSON Body to update filters", required = false)
    ...
    Map<String, Object> learningFilters =
        learningContentService.getViewMoreNewFiltersWithCount(filtersSelected, hcaasStatus);
    LOG.info(
        "Received new learning content in {} ", (System.currentTimeMillis() - requestStartTime));
  ...
  @ApiOperation(
      value = "Update registration or view status for users",
      nickname = "updateUserStatus",
      response = LearningStatusEntity.class)
  @ApiResponses(
      value = {
  ...
  public ResponseEntity updateStatus(
      @ApiParam(value = "Mashery user credential header")
          ...
          String xMasheryHandshake,
      @ApiParam(value = "puid") @RequestHeader(value = "puid", required = true) String puid,
      @ApiParam(value = "JSON Body to update user status", required = true) @Valid @RequestBody
    ...
    LearningStatusEntity learningStatusEntity =
        learningContentService.updateUserStatus(
            userId, puid, learningStatusSchema, xMasheryHandshake);
  ...
  @ApiOperation(
      value = "Fetch recently viewed Learning Content",
      nickname = "fetchrecentlyviewedlearningcontent")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<List<LearningContentItem>> getRecentlyViewedContent(
    ...
    boolean hcaasStatus = getHcaasStatus(request);
    String userId = MasheryObject.getInstance(xMasheryHandshake).getCcoId();
    List<LearningContentItem> learningContentList =
        learningContentService.fetchRecentlyViewedContent(userId, filtersSelected, hcaasStatus);
    LOG.info(
        "Received recently viewed learning content in {} ",
  ...
  @PostMapping(
      ...
      path = "/viewmore/recentlyviewed/filters")
  @ApiOperation(
      value = "Fetch All Learnings Filters for recently viewed section",
      nickname = "fetchallrecentlyViewedFilters")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<Map<String, Object>> getFiltersForRecentlyViewed(
    ...
    String userId = MasheryObject.getInstance(xMasheryHandshake).getCcoId();
    Map<String, Object> learningFilters =
        learningContentService.getRecentlyViewedFiltersWithCount(
            userId, filtersSelected, hcaasStatus);
    LOG.info(
        "Received recently viewed filter counts in {} ",
        (System.currentTimeMillis() - requestStartTime));
    return new ResponseEntity<>(learningFilters, HttpStatus.OK);
  }
  ...
  @ApiOperation(
      value = "Fetch bookmarked Learning Content",
      nickname = "fetchbookmarkedlearningcontent")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<List<LearningContentItem>> getBookmarkedContent(
    ...
    String userId = MasheryObject.getInstance(xMasheryHandshake).getCcoId();
    List<LearningContentItem> learningContentList =
        learningContentService.fetchBookMarkedContent(userId, filtersSelected, hcaasStatus);
    LOG.info(
        "Received bookmarked learning content in {} ",
        (System.currentTimeMillis() - requestStartTime));
    return new ResponseEntity<>(learningContentList, HttpStatus.OK);
  }
  ...
  @ApiOperation(
      value = "Fetch All Learnings Filters for recently viewed section",
      nickname = "fetchallBookmarkedFilters")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<Map<String, Object>> getFiltersForBookmarked(
    ...
    String userId = MasheryObject.getInstance(xMasheryHandshake).getCcoId();
    Map<String, Object> learningFilters =
        learningContentService.getBookmarkedFiltersWithCount(userId, filtersSelected, hcaasStatus);
    LOG.info(
        "Received bookmarked filter counts in {} ",
        (System.currentTimeMillis() - requestStartTime));
    return new ResponseEntity<>(learningFilters, HttpStatus.OK);
  }
  ...
  @ApiOperation(
      value = "Fetch bookmarked Learning Content",
      nickname = "fetchupcominglearningcontent")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<List<LearningContentItem>> getUpcomingContent(
    ...
    String userId = MasheryObject.getInstance(xMasheryHandshake).getCcoId();
    List<LearningContentItem> learningContentList =
        learningContentService.fetchUpcomingContent(userId, filtersSelected, hcaasStatus);
    LOG.info(
        "Received bookmarked learning content in {} ",
        (System.currentTimeMillis() - requestStartTime));
    return new ResponseEntity<>(learningContentList, HttpStatus.OK);
  ...
  @ApiOperation(
      value = "Fetch All Learnings Filters for recently viewed section",
      nickname = "fetchallUpcomingFilters")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<Map<String, Object>> getFiltersForUpcoming(
    ...
    boolean hcaasStatus = getHcaasStatus(request);
    Map<String, Object> learningFilters =
        learningContentService.getUpcomingFiltersWithCount(filtersSelected, hcaasStatus);
    LOG.info(
        "Received upcoming filter counts in {} ", (System.currentTimeMillis() - requestStartTime));
    return new ResponseEntity<>(learningFilters, HttpStatus.OK);
  }
  ...
  public ResponseEntity<List<LearningContentItem>> getCXInsightsContent(
      @ApiParam(value = "Mashery user credential header")
          @RequestHeader(value = "X-Mashery-Handshake", required = false)
          String xMasheryHandshake,
      @ApiParam(value = "search") @RequestParam(value = "search", required = false)
          String searchToken,
      @ApiParam(value = "sortfield") @RequestParam(value = "sortfield", required = false)
          String sortField,
      @ApiParam(value = "sorttype") @RequestParam(value = "sorttype", required = false)
          String sortType,
      @ApiParam(value = "Filters") @RequestBody(required = false)
          Map<String, Object> filtersSelected,
      @ApiParam(value = "puid") @RequestHeader(value = "puid", required = true) String puid,
    ...
    List<LearningContentItem> learningContentList =
        learningContentService.fetchCXInsightsContent(
            userId, filtersSelected, searchToken, sortField, sortType, hcaasStatus);
  ...
  @ApiOperation(
      value = "Fetch All Learnings Filters for cx insights section",
      nickname = "fetchallCXInsightsFilters")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<Map<String, Object>> getFiltersForCXInsights(
    ...
    String userId = MasheryObject.getInstance(xMasheryHandshake).getCcoId();
    Map<String, Object> learningFilters =
        learningContentService.getCXInsightsFiltersWithCount(
            userId, searchToken, filtersSelected, hcaasStatus);
    LOG.info(
        "Received cx insights filter counts in {} ",
        (System.currentTimeMillis() - requestStartTime));
    return new ResponseEntity<>(learningFilters, HttpStatus.OK);
  }
  ...
  public ResponseEntity<LearningMap> getLearningMap(
      @ApiParam(value = "Mashery user credential header")
          ...
          String xMasheryHandshake,
      @ApiParam(value = "puid") @RequestHeader(value = "puid", required = true) String puid,
      @ApiParam(value = "Learning Map ID", required = false)
          @RequestParam(value = "id", required = false)
          String id,
      @ApiParam(value = "Learning Map Title", required = false)
  ...
  @ApiOperation(
      value = "Fetch popular content across or within a partner company",
      nickname = "fetchPopularContent")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<List<LearningContentItem>> getPopularContent(
      @ApiParam(value = "popularity type. It can be 'popularAcrossPartners' or 'popularAtPartner'")
          @PathVariable(value = "popularityType", required = true)
    ...
    if (!(popularityType.equals(Constants.POPULAR_ACROSS_PARTNERS_PATH)
        || popularityType.equals(Constants.POPULAR_AT_PARTNER_PATH))) {
    ...
    List<LearningContentItem> learningContentList =
        learningContentService.fetchPopularContent(
            userId, filtersSelected, popularityType, puid, hcaasStatus);
  ...
  @PostMapping(
      produces = MediaType.APPLICATION_JSON_VALUE,
      path = "/viewmore/popular/{popularityType}/filters")
  @ApiOperation(
      value = "Fetch Learning Filters for popularAcrossPartners or popularAtPartners section",
      nickname = "fetchPopularContentFilters")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<Map<String, Object>> getPopularContentFilters(
    ...
    Map<String, Object> learningFilters =
        learningContentService.getPopularContentFiltersWithCount(
            filtersSelected, puid, popularityType, userId, hcaasStatus);
    LOG.info(
        "Received popular content filters counts in {} ",
        (System.currentTimeMillis() - requestStartTime));
    return new ResponseEntity<>(learningFilters, HttpStatus.OK);
  }
  ...
  @ApiOperation(
      value = "Fetch bookmarked Learning Content",
      nickname = "fetchfeaturedlearningcontent")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<List<LearningContentItem>> getFeaturedContent(
    ...
    String userId = MasheryObject.getInstance(xMasheryHandshake).getCcoId();
    List<LearningContentItem> learningContentList =
        learningContentService.fetchFeaturedContent(userId, filtersSelected, hcaasStatus);
    LOG.info(
        "Received featured learning content in {} ",
        (System.currentTimeMillis() - requestStartTime));
    return new ResponseEntity<>(learningContentList, HttpStatus.OK);
  }
  ...
  @ApiOperation(
      value = "Fetch All Learnings Filters for recently viewed section",
      nickname = "fetchallFeaturedFilters")
  @ApiResponses(
      value = {
        @ApiResponse(code = 200, message = "Successfully retrieved results"),
        @ApiResponse(code = 400, message = "Bad Input", response = ErrorResponse.class),
  ...
  public ResponseEntity<Map<String, Object>> getFiltersForFeatured(
    ...
    boolean hcaasStatus = getHcaasStatus(request);
    Map<String, Object> learningFilters =
        learningContentService.getFeaturedFiltersWithCount(filtersSelected, hcaasStatus);
    LOG.info(
        "Received featured filter counts in {} ", (System.currentTimeMillis() - requestStartTime));
    return new ResponseEntity<>(learningFilters, HttpStatus.OK);
  }
