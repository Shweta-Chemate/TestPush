...
public class SuccesstalkUserRegEsSchema implements HasId {
  ...
  public SuccesstalkUserRegEsSchema(
      String title, Long eventStartDate, String ccoid, RegistrationStatusEnum registrationStatus) {
    this.ccoid = ccoid;
  ...
  public boolean equals(Object o) {
    ...
    return getCcoid().equals(that.getCcoid())
        && getTitle().equals(that.getTitle())
        && getEventStartDate().equals(that.eventStartDate);
  }
  ...
  public enum RegistrationStatusEnum {
    ...
    public static SuccesstalkUserRegEsSchema.RegistrationStatusEnum fromValue(String text) {
      for (SuccesstalkUserRegEsSchema.RegistrationStatusEnum b :
          SuccesstalkUserRegEsSchema.RegistrationStatusEnum.values()) {
  ...
  public enum AttendedStatusEnum {
    ...
    public static SuccesstalkUserRegEsSchema.AttendedStatusEnum fromValue(String text) {
      for (SuccesstalkUserRegEsSchema.AttendedStatusEnum b :
          SuccesstalkUserRegEsSchema.AttendedStatusEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
  ...
  public void setEventStartDate(Long eventStartDate) {
    ...
    this.eventStartDateFormatted =
        (eventStartDate != null)
            ? new SimpleDateFormat(SMARTSHEET_DATE_FORMAT).format(new Date(eventStartDate))
            : null;
  }
  ...
  public void setEventStartDateFormatted(String eventStartDateFormatted) {
    ...
    try {
      this.eventStartDate =
          StringUtils.isNotBlank(eventStartDateFormatted)
              ? new SimpleDateFormat(SMARTSHEET_DATE_FORMAT)
                  .parse(eventStartDateFormatted)
                  .getTime()
              : null;
    } catch (ParseException | NullPointerException | IllegalArgumentException e) {
      LOG.warn(
          "Could not parse pattern {} from date value {}",
  ...
  public void setRegistrationDate(Long registrationDate) {
    ...
    this.registrationDateFormatted =
        (registrationDate != null)
            ? new SimpleDateFormat(SMARTSHEET_DATE_FORMAT).format(new Date(registrationDate))
            : null;
  }
  ...
  public void setRegistrationDateFormatted(String registrationDateFormatted) {
    ...
    try {
      this.registrationDate =
          StringUtils.isNotBlank(registrationDateFormatted)
              ? new SimpleDateFormat(SMARTSHEET_DATE_FORMAT)
                  .parse(registrationDateFormatted)
                  .getTime()
              : null;
    } catch (ParseException | NullPointerException | IllegalArgumentException e) {
      LOG.warn(
