package com.cisco.services.app.rest;

import com.cisco.services.app.config.PropertyConfiguration;
import com.cisco.services.app.dao.ElasticSearchDAO;
import com.cisco.services.app.exception.BadRequestException;
import com.cisco.services.app.exception.ErrorResponse;
import com.cisco.services.app.exception.HealthCheckException;
import com.cisco.services.app.service.CiscoProfileService;
import com.cisco.services.app.service.EmailService;

import com.cisco.services.util.ValidationUtil;
...
@Api(value = "Template APIs", description = "Sample CRUD operation example")
